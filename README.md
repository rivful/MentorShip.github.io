# MentorMe | Internal Mentorship Discovery Platform
...
* **Performance Optimization:** Engineered a custom modal system and streamlined JavaScript logic to handle high-frequency user interactions and form submissions.
...
As an **Associate Software Engineer** with a background in high-reliability C++ and Python systems at **Bloomberg**, I built this project to demonstrate how technical architecture can solve organizational "people" challenges. By focusing on clean code and accessibility, I’ve applied the same rigour used to reduce system latency by 50% to the world of web applications.
